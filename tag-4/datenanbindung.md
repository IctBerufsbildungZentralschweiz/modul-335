...
Ionic hat auch fürs persistieren von einfachen Daten eine Lösung bereit: [https://beta.ionicframework.com/docs/building/storage](https://beta.ionicframework.com/docs/building/storage)
