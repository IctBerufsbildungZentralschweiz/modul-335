...
{% api-method method="get" host="https://sheetdb.io/" path="api/v1/cnwjgzatzbkgq?sheet=person" %}
{% api-method-summary %}
person
...
{% api-method-parameter name="sheet=person" type="string" required=true %}
...
{% api-method method="post" host="https://sheetdb.io/" path="api/v1/cnwjgzatzbkgq?sheet=person" %}
{% api-method-summary %}
person
{% endapi-method-summary %}
...
{% api-method-request %}
{% api-method-headers %}
{% api-method-parameter name="Content-Type: application/json" type="string" required=true %}
